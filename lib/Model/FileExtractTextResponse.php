...
use \ArrayAccess;
/**
 * FileExtractTextResponse Class Doc Comment
 *
 * @category    Class
 * @description Response for a File Extract Text request
 * @package     Systran\Client
 * @author      http://github.com/Systran-api/Systran-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link
 */
class FileExtractTextResponse implements ArrayAccess
{
    /**
    ...
    /**
      * $text Text extracted from the input
      * @var string
      */
    protected $text;
    ...
    /**
     * Sets text
     * @param string $text Text extracted from the input
     * @return $this
     */
