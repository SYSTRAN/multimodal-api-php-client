...
use \ArrayAccess;
/**
 * SpeechAlignResponse Class Doc Comment
 *
 * @category    Class
 * @description Response of a Speech Align request
 * @package     Systran\Client
 * @author      http://github.com/Systran-api/Systran-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link
 */
class SpeechAlignResponse implements ArrayAccess
{
    /**
    ...
    static $SystranTypes = array(
        ...
        'segments' => '\Systran\Client\SpeechAlignSegment[]'
    );
    ...
    /**
      ...
      * @var \Systran\Client\SpeechAlignSegment[]
      */
    protected $segments;
    ...
    /**
     * Gets segments
     * @return \Systran\Client\SpeechAlignSegment[]
     */
    ...
    /**
     * Sets segments
     * @param \Systran\Client\SpeechAlignSegment[] $segments Array of segments
     * @return $this
     */
