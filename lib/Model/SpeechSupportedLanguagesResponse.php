<?php
/**
 * SpeechSupportedLanguagesResponse
 *
 * PHP version 5
 *
 * @category Class
...
use \ArrayAccess;
/**
 * SpeechSupportedLanguagesResponse Class Doc Comment
 *
 * @category    Class
 * @description Response of a Speech Supported languages request
 * @package     Systran\Client
 * @author      http://github.com/Systran-api/Systran-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link
 */
class SpeechSupportedLanguagesResponse implements ArrayAccess
{
    /**
