...
use \ArrayAccess;
/**
 * SpeechTranscribeSpeaker Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Systran\Client
 ...
 * @link
 */
class SpeechTranscribeSpeaker implements ArrayAccess
{
    /**
    ...
    /**
      * $nb_words number of spoken words
      * @var int
      */
    protected $nb_words;
    ...
    /**
     * Sets nb_words
     * @param int $nb_words number of spoken words
     * @return $this
     */
    public function setNbWords($nb_words)
    {
